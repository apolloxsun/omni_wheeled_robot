...
void loop() {
  ...
  if(givenAng>=45 && givenAng<225){ //forward
    ...
    analogWrite(motor1_IN1, speedX); analogWrite(motor2_IN2, speedX); analogWrite(motor3_IN1, speedX); analogWrite(motor4_IN2, speedX);

  }
  else if((givenAng>=225 && givenAng<360) || (givenAng>=0 && givenAng<45)){ //left
    digitalWrite(motor1_IN1, LOW); digitalWrite(motor1_IN2, HIGH);
    digitalWrite(motor2_IN1, LOW); digitalWrite(motor2_IN2, HIGH);
    digitalWrite(motor3_IN1, LOW); digitalWrite(motor3_IN2, HIGH);
    digitalWrite(motor4_IN1, LOW); digitalWrite(motor4_IN2, HIGH);
    analogWrite(motor1_IN2, speedY); analogWrite(motor2_IN2, speedY); analogWrite(motor3_IN2, speedY); analogWrite(motor4_IN2, speedY);
  }
